...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        log.info("Seed complete: {} users, {} restaurants (default password '{}')",
                userRepository.count(), restaurantRepository.count(), DEFAULT_PASSWORD);
    }
